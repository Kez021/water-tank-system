...
public class AdminAuthController {
    ...
    /* ==== Credentials (server-side) ====
       Use ADMIN_USERNAME / ADMIN_PASSWORD environment variables in Render.
       Defaults keep localhost working without changing code. */
    private static final String ADMIN_USERNAME = System.getenv().getOrDefault("ADMIN_USERNAME", "admin");
    private static final String ADMIN_PASSWORD = System.getenv().getOrDefault("ADMIN_PASSWORD", "tank@admin2026");
